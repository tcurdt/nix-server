...
let
  ...
  normalizeInstance = _name: instanceCfg: {
    ...
    environmentFile = inheritOr instanceCfg.environmentFile cfg.environmentFile;
    ...
    type = lib.types.submodule {
      options = {
        ...
        environmentFile = lib.mkOption {
          ...
          default = null;
          description = "Default systemd EnvironmentFile for litestream instances.";
        };
            ...
            lib.types.submodule {
              options = {
                ...
                environmentFile = lib.mkOption {
                  type = lib.types.nullOr lib.types.str;
                  default = null;
                  description = "Systemd EnvironmentFile for this instance. Null inherits services.my.litestream.environmentFile.";
                };
    ...
    users.users = lib.listToAttrs (
      map (
        ...
        lib.nameValuePair user {
          isSystemUser = true;
          group = user;
          home = lib.mkDefault "/var/lib/litestream";
        }
      ) enabledUsers
    );
